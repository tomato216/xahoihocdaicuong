// Bộ câu hỏi 1 (Độ khó: Dễ - Trung bình) - Tác giả: AUGUSTE COMTE
const QUIZ_QUESTIONS = [
    ...
    },
    {
        ...
        correct: "C",
        explain: "In thời đại thực chứng, các nhà khoa học thực chứng sẽ chịu trách nhiệm định hướng tinh thần, đạo đức, còn các nhà công nghiệp sẽ điều hành hoạt động kinh tế và xã hội thực tế."
    },
    {
    ...
    },
    {
        ...
        correct: "B",
        explain: "Comte muốn dùng các tiêu chuẩn, phương pháp khách quan như quan sát, thực nghiệm của vật lý học và các khoa học tự nhiên khác để đưa xã hội học trở thành một khoa học thực chứng thực thụ."
    },
    {
    ...
    },
    {
        ...
        answers: { A: "Tăng trưởng kinh tế và tích lũy của cải vật chất cho thế hệ sau", B: "Giáo dục xã hội hóa bước đầu, dạy cá nhân biết kiểm sở hữu sự ích kỷ và sống vì người khác", C: "Quyết định các hoạt động chính trị của các thành viên trong gia đình", D: "Cung cấp lao động giá rẻ cho các nhà máy công nghiệp thời kỳ đó" },
        correct: "B",
    ...
    },
    {
        ...
        answers: { A: "Ngẫu nhiên, không theo quy luật cụ thể nào", B: "Thụt lùi dần theo thời gian do sự suy đồi đạo đức", C: "Tiến hóa tất yếu, tuần tự và mang tính tiến bộ", D: "Luẩn quẩn, tuần hoàn theo các chu kỳ khép kín" },
        correct: "C",
